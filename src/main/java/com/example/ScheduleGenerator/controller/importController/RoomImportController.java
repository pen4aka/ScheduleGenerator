...
public class RoomImportController {
    ...
    @PostMapping(value = "/excel-RoomImport", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public ResponseEntity<String> importRooms(@RequestParam("file") MultipartFile file) throws IOException {
        excelImportService.importRoomsFromExcel(file);
